...
loss_curve_flat <- function(r,a,d,Eb,tc,te,t,group){
...
loss_curve_piecewise_bi <- function(r,a1,a2,d1,d2,Ei,te,t,group){
  E <- #ifelse(group == "non-immersion",
#              En,
...
loss_piecewise_elogit_bi <- function(par){
...
loss_piecewise_irt_bi <- function(par){
  sum(((1 - exp(loss_curve_piecewise(r = par[1], a1 = par[2], a2 = par[3], d1 = par[4],
...
loss_curve_piecewise_asymptote_bi <- function(r,a1,a2,d1,d2,e,Ei,te,t,group){
  E <- #ifelse(group == "non-immersion",
#              En,
#              ifelse(group == "immersion",
#                     Ei,
...
loss_piecewise_asymptote_bi <- function(par){
